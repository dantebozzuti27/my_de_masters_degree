...
export const Q1_LESSONS: Lesson[] = [
  ...
  { dayNumber: 93, week: 24, topic: "Accept Offer", subtitle: "YOU DID IT", objectives: ["Accept the offer", "Get everything in writing"], aiIntegration: { toolsUsed: ['none'], focusArea: 'manual-practice', aiTip: "Read the contract carefully." }, sessionPlan: [{ time: "0:00-1:30", activity: "Accept offer", type: "exercise" }], resources: { required: [] }, exercises: [{ title: "Accept Offer", deliverable: "SIGNED OFFER" }], successCriteria: ["OFFER ACCEPTED"], futureProofNote: "GOAL ACHIEVED." },
