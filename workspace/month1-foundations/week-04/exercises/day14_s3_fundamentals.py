...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        print("Day 14: S3 Fundamentals")
        print("=" * 40)
        print("\nThis is an S3-focused day.")
        print("Follow exercises in AWS Console and with this code.")
        print("\nCommands:")
        print("  python day14_s3_fundamentals.py verify    - Verify S3 access")
        print("  python day14_s3_fundamentals.py list      - List your buckets")
        print("  python day14_s3_fundamentals.py cost [GB] - Cost comparison")
        print("  python day14_s3_fundamentals.py partition - Show partition example")
